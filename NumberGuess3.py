# Number guess game. Modifications made for game to run on Python 3 instead of Python 2.
# Changes in Python 3: A) print statement now uses parentheses B) raw_input() is replaced with input() 
...
#6a. For Python 3, use input() instead of raw_input()
